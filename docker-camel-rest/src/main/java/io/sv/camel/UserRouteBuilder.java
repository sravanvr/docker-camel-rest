...
public class UserRouteBuilder extends RouteBuilder {
	...
	public void configure() throws Exception {
		...
		// this user REST service is json only
		rest("/user") //.consumes("application/xml").produces("application/xml")
			.get("/accounts").outType(String.class)
			.to("bean:accountService?method=getAccountsResposneFromAccountsMicroService")
			//.to("http://153.83.18.98:1234/AccountInquiry/getAccounts?bridgeEndpoint=true&throwExceptionOnFailure=false")
			//.to("jetty:http://153.83.18.98:1234/AccountInquiry/getAccounts?bridgeEndpoint=true&throwExceptionOnFailure=false")
